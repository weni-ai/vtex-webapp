...
export function AgentsList({ onAssign, originFilter }: AgentsListProps) {
  ...
  const unassignedAgents = useSelector(agentsSelector).filter((agent) => {
    ...
    // TODO: código que o cursor criou
    // if (agent.isAssigned) return false;
    // if (originFilter && agent.origin !== originFilter) return false;
    // // TODO: CHECK IF THIS NOTIFICATION TYPE CHECK MAKES SENSE
    // if (embeddedWithin === 'Weni Platform') return agent.notificationType === 'active';
    // return true;
  });
